...
\paragraph{}A klasszikus Z-buffer\index{Z-buffer}\index{depth buffer} technika bár megfelelő eredményeket tud produkálni átlátszatlan felületek esetén, áttetsző felületek/közegek pontos kirajolására alkalmatlan.
